"""
Django settings for live_in_backend project.
...
DEBUG = str(env('DEBUG')).lower() in ('true', '1')

ALLOWED_HOSTS = str(env('ALLOWED_HOSTS')).split(',')

ADMIN_ENABLED = str(env('ADMIN_ENABLED')).lower() in ('true', '1')
...
ROOT_URLCONF = 'live_in_backend.urls'
...
WSGI_APPLICATION = 'live_in_backend.wsgi.application'
